...
raw_item_data: t.Tuple[AVItemData] = (
    ...
    AVItemData(21, "Heat Seeker", AVItemType.WEAPON, ItemClassification.progression, True),
    AVItemData(22, "Scissor Beam", AVItemType.WEAPON, ItemClassification.progression, True),
