...
raw_item_data: t.Tuple[AVItemData] = (
    ...
    ("InertialPulse", AVItemType.WEAPON, ItemClassification.progression_skip_balancing),
    ...
    # ("Shards", AVItemType.WEAPON, ItemClassification.progression_skip_balancing),
    ...
    ("Address Disruptor 1", AVItemType.GLITCH, ItemClassification.progression),
    ("Address Disruptor 2", AVItemType.GLITCH, ItemClassification.progression),
    ("Laser Drill", AVItemType.DRILL, ItemClassification.progression),
    ("Remote Drone", AVItemType.DRONE, ItemClassification.progression),
    ("Address Bomb", AVItemType.GLITCH, ItemClassification.progression),
    # (29, "Grapple", AVItemType.MOVEMENT, True),
    # (30, "HighJump", AVItemType.MOVEMENT, True),
    ("Modified Lab Coat", AVItemType.COAT, ItemClassification.progression),
    ("Trenchcoat", AVItemType.COAT, ItemClassification.progression),
    ("Red Coat", AVItemType.COAT, ItemClassification.progression),
    # (34, "BreachSuppressor", AVItemType.KEY, True),
    ("Enhanced Drone Launch", AVItemType.DRONE, ItemClassification.progression),
    ("Drone Teleport", AVItemType.DRONE, ItemClassification.progression),
    ("Passcode Tool", AVItemType.KEY, ItemClassification.progression),
    ("TendrilsTop", AVItemType.TENDRILS, ItemClassification.filler),
    ("TendrilsBottom", AVItemType.TENDRILS, ItemClassification.filler),
    ("HealthNode1", AVItemType.HEALTH_NODE, ItemClassification.useful),
    ("HealthNode2", AVItemType.HEALTH_NODE, ItemClassification.useful),
    ("HealthNode3", AVItemType.HEALTH_NODE, ItemClassification.useful),
    ...
    ("PowerNode2", AVItemType.POWER_NODE, ItemClassification.useful),
    # ("PowerNode3", AVItemType.POWER_NODE, ItemClassification.useful),
    ...
    ("HealthNodeFragment1", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    ("HealthNodeFragment2", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    ("HealthNodeFragment3", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    ("HealthNodeFragment4", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    ...
    ("PowerNodeFragment1", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.useful),
    ("PowerNodeFragment2", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.useful),
    ("PowerNodeFragment3", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.useful),
    ("PowerNodeFragment4", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.useful),
    ("PowerNodeFragment5", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.useful),
    ("PowerNodeFragment6", AVItemType.POWER_NODE_FRAGMENT, ItemClassification.useful),
    ...
    ("RangeNode1", AVItemType.RANGE_NODE, ItemClassification.useful),
    ("RangeNode2", AVItemType.RANGE_NODE, ItemClassification.useful),
    # ("RangeNode3", AVItemType.RANGE_NODE),
    # ("RangeNode4", AVItemType.RANGE_NODE),
    ("SizeNode1", AVItemType.SIZE_NODE, ItemClassification.useful),
    ("SizeNode2", AVItemType.SIZE_NODE, ItemClassification.useful),
