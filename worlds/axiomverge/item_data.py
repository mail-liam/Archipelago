...
raw_item_data: t.Tuple[AVItemData] = (
    ...
    ("AddressDisruptor2", AVItemType.GLITCH, ItemClassification.progression),
    ("Drill", AVItemType.DRILL, ItemClassification.progression),
    ("Drone", AVItemType.DRONE, ItemClassification.progression),
    ("GlitchBomb", AVItemType.GLITCH, ItemClassification.progression),
