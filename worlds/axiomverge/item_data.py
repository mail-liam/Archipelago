...
raw_item_data: t.Tuple[int, str, AVItemType, ItemClassification] = (
    ...
    (64, "HealthNodeFragment6", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    (65, "HealthNodeFragment7", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    (66, "HealthNodeFragment8", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    (67, "HealthNodeFragment9", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
    (68, "HealthNodeFragment10", AVItemType.HEALTH_NODE_FRAGMENT, ItemClassification.useful),
