...
entrance_data: t.Tuple[t.Tuple[str, str, AccessRule, bool]] = (
    ...
    (AVRegions.LOWER_CAVES, AVRegions.UPPER_CAVES, conditions.any_coat, True),
    (AVRegions.LOWER_CAVES, AVRegions.GAUNTLET_ROOM, conditions.kur_gauntlet_access, False),
    (AVRegions.UPPER_CAVES, AVRegions.KUR_INDI, conditions.any_coat, True),
    ...
    # WIP
    (AVRegions.GIR_TAB, AVRegions.UPPER_CAVES, lambda s, c: conditions.has_trenchcoat(s, c) or conditions.has_glitch_2(s, c), False, 'Gir-Tab Lower Exit'),
...
location_data: t.Tuple[AVLocationData] = (
    ...
    AVLocationData(60, 'Kur - Gauntlet Reward', AVRegions.LOWER_CAVES, conditions.always_accessible),
