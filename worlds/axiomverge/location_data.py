...
location_data: tuple[AVLocationData] = (
    ...
    AVLocationData(50, AVArea.ZI, 'Drone Tunnel Upper', AVRegions.UPPER_ZI, conditions.zi_drone_tunnel_access),
    AVLocationData(51, AVArea.ZI, 'Drone Tunnel End', AVRegions.UPPER_ZI, conditions.zi_drone_tunnel_access),
