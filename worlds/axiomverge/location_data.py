...
entrance_data: tuple[tuple[str, str, AccessRule, bool]] = (
    ...
    (AVRegion.INDI, AVRegion.LOWER_EDIN, conditions.indi_edin_access, False),
    ...
    (AVRegion.EAST_UKKIN_NA_EXIT, AVRegion.LOWER_EDIN, conditions.always_accessible, True),
    (AVRegion.SOUTH_UKKIN_NA_EXIT, AVRegion.INDI, conditions.ukkin_na_indi_access, False),

    (AVRegion.LOWER_EDIN, AVRegion.UKHU, conditions.ukhu_access, False),
    (AVRegion.UKHU, AVRegion.LOWER_EDIN, conditions.ukhu_exit_access, False),
    (AVRegion.LOWER_EDIN, AVRegion.CLONE, conditions.vanilla_clone_access, False),
    (AVRegion.CLONE, AVRegion.LOWER_EDIN, conditions.has_trenchcoat, False),
    (AVRegion.LOWER_EDIN, AVRegion.HANGAR, conditions.edin_hangar_left_access, True),
    ...
    (AVRegion.LOWER_EDIN, AVRegion.INDI, lambda s, c: conditions.has_trenchcoat(s, c) or conditions.floor_grapple_clip(s, c), False),
...
location_data: tuple[AVLocationData] = (
    ...
    AVLocationData(91, AVArea.EDIN, 'Ceiling Near Ukkin-Na', AVRegion.LOWER_EDIN, conditions.edin_roof_ledge_access),
    AVLocationData(92, AVArea.EDIN, 'Sky Cage', AVRegion.LOWER_EDIN, conditions.roof_cage_access),
    AVLocationData(93, AVArea.EDIN, 'Central Ruins Glitch Alcove', AVRegion.LOWER_EDIN, conditions.has_glitch_bomb),
    AVLocationData(94, AVArea.EDIN, 'Secret Tunnel Near Indi', AVRegion.LOWER_EDIN, lambda s, c: conditions.has_trenchcoat(s, c) and conditions.has_drone(s, c)),
