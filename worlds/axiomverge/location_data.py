...
entrance_data: t.Tuple[t.Tuple[str, str, AccessRule, bool]] = (
    ...
    # WIP
    (AVRegions.UPPER_KUR, AVRegions.GIR_TAB, lambda s, c: conditions.has_trenchcoat(s, c) or conditions.has_glitch_2(s, c), False, 'Gir-Tab Lower Entrance'),
    (AVRegions.GIR_TAB, AVRegions.UPPER_KUR, lambda s, c: conditions.has_trenchcoat(s, c) or conditions.has_glitch_2(s, c), False, 'Gir-Tab Lower Exit'),
    ...
    (AVRegions.EAST_EDIN, AVRegions.UPPER_KUR, conditions.not_implemented, True),

    (AVRegions.UPPER_KUR, AVRegions.UPPER_E_KUR_MAH, conditions.not_implemented, True),
...
location_data: t.Tuple[AVLocationData] = (
    ...
    AVLocationData(63, 'Kur - Above Twin Save Rooms', AVRegions.UPPER_KUR, conditions.not_implemented),
    AVLocationData(64, 'Kur - Floating Ledge', AVRegions.UPPER_KUR, conditions.has_drone),
    AVLocationData(65, 'Kur - Inside Cliff', AVRegions.UPPER_KUR, conditions.has_red_coat),
    ...
    AVLocationData(73, 'Kur - Gir-Tab Lower Entrance Drone Tunnel', AVRegions.GIR_TAB, conditions.has_drone),
    AVLocationData(74, 'Kur - Gir-Tab Upper Entrance', AVRegions.GIR_TAB, conditions.always_accessible),
    AVLocationData(75, 'Kur - Internal Cliffs near False Floor', AVRegions.GIR_TAB, conditions.not_implemented),
    AVLocationData(76, 'Kur - Internal Cliffs Shrine', AVRegions.GIR_TAB, conditions.not_implemented),
    AVLocationData(77, 'Kur - Internal Cliffs Above Shrine', AVRegions.GIR_TAB, conditions.not_implemented),
